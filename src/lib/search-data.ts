...
export const searchResults: SearchResult[] = [
  ...
  { category: "News", icon: "mdi:newspaper-variant-outline", title: "Bitcoin Breaks $67K as ETF Inflows Surge", meta: "News · Cointelegraph · 1h ago · Bullish", href: "/news-terminal" },
  { category: "News", icon: "mdi:newspaper-variant-outline", title: "Fed Signals Caution as Inflation Remains Sticky", meta: "News · Bloomberg · 2h ago · Bearish", href: "/news-terminal" },
